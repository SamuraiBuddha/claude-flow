...
exports.createAnalystAgent = exports.AnalystAgent = void 0;
const base_agent_js_1 = require("./base-agent.js");
class AnalystAgent extends base_agent_js_1.BaseAgent {
...
const createAnalystAgent = (id, config, environment, logger, eventBus, memory) => {
    ...
    return new AnalystAgent(id, { ...defaultConfig, ...config }, { ...defaultEnv, ...environment }, logger, eventBus, memory);
};
