...
exports.createArchitectAgent = exports.ArchitectAgent = void 0;
...
const createArchitectAgent = (id, config, environment, logger, eventBus, memory) => {
    const defaultConfig = {
        autonomyLevel: 0.8,
        learningEnabled: true,
        adaptationEnabled: true,
...
exports.createArchitectAgent = createArchitectAgent;
