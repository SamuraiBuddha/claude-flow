...
exports.createCoderAgent = exports.CoderAgent = void 0;
...
const createCoderAgent = (id, config, environment, logger, eventBus, memory) => {
    const defaultConfig = {
        autonomyLevel: 0.7,
        learningEnabled: true,
        adaptationEnabled: true,
    ...
    return new CoderAgent(id, { ...defaultConfig, ...config }, { ...defaultEnv, ...environment }, logger, eventBus, memory);
};
exports.createCoderAgent = createCoderAgent;
