...
exports.createCoordinatorAgent = exports.CoordinatorAgent = void 0;
...
const createCoordinatorAgent = (id, config, environment, logger, eventBus, memory) => {
    const defaultConfig = {
        autonomyLevel: 0.9,
        learningEnabled: true,
        adaptationEnabled: true,
    ...
    return new CoordinatorAgent(id, { ...defaultConfig, ...config }, { ...defaultEnv, ...environment }, logger, eventBus, memory);
};
