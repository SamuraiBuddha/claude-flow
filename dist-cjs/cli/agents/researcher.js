...
exports.createResearcherAgent = exports.ResearcherAgent = void 0;
const base_agent_js_1 = require("./base-agent.js");
class ResearcherAgent extends base_agent_js_1.BaseAgent {
...
const createResearcherAgent = (id, config, environment, logger, eventBus, memory) => {
    const defaultConfig = {
        autonomyLevel: 0.8,
        learningEnabled: true,
        adaptationEnabled: true,
    ...
    return new ResearcherAgent(id, { ...defaultConfig, ...config }, { ...defaultEnv, ...environment }, logger, eventBus, memory);
};
exports.createResearcherAgent = createResearcherAgent;
