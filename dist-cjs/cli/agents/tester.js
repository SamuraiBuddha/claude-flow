...
exports.createTesterAgent = exports.TesterAgent = void 0;
const base_agent_js_1 = require("./base-agent.js");
class TesterAgent extends base_agent_js_1.BaseAgent {
...
const createTesterAgent = (id, config, environment, logger, eventBus, memory) => {
    const defaultConfig = {
        autonomyLevel: 0.7,
        learningEnabled: true,
        adaptationEnabled: true,
    ...
    return new TesterAgent(id, { ...defaultConfig, ...config }, { ...defaultEnv, ...environment }, logger, eventBus, memory);
};
