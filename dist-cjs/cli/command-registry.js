...
exports.showAllCommands = showAllCommands;
// command-registry.js - Extensible command registration system
const process_1 = __importDefault(require("process"));
const index_js_1 = require("./simple-commands/init/index.js");
const memory_js_1 = require("./simple-commands/memory.js");
const sparc_js_1 = require("./simple-commands/sparc.js");
const agent_js_1 = require("./simple-commands/agent.js");
const task_js_1 = require("./simple-commands/task.js");
const config_js_1 = require("./simple-commands/config.js");
const status_js_1 = require("./simple-commands/status.js");
const mcp_js_1 = require("./simple-commands/mcp.js");
const monitor_js_1 = require("./simple-commands/monitor.js");
const start_js_1 = require("./simple-commands/start.js");
const swarm_js_1 = require("./simple-commands/swarm.js");
const batch_manager_js_1 = require("./simple-commands/batch-manager.js");
const github_js_1 = require("./simple-commands/github.js");
const training_js_1 = require("./simple-commands/training.js");
const analysis_js_1 = require("./simple-commands/analysis.js");
const automation_js_1 = require("./simple-commands/automation.js");
const coordination_js_1 = require("./simple-commands/coordination.js");
const hooks_js_1 = require("./simple-commands/hooks.js");
const hook_safety_js_1 = require("./simple-commands/hook-safety.js");
const hive_mind_js_1 = require("./simple-commands/hive-mind.js");
const help_formatter_js_1 = require("./help-formatter.js");
const hive_mind_optimize_js_1 = __importDefault(require("./simple-commands/hive-mind-optimize.js"));
const swarm_metrics_integration_js_1 = require("./simple-commands/swarm-metrics-integration.js");
const migrate_hooks_js_1 = require("./simple-commands/migrate-hooks.js");
const fix_hook_variables_js_1 = require("./simple-commands/fix-hook-variables.js");
...
exports.commandRegistry = new Map();
// Register core commands
function registerCoreCommands() {
    exports.commandRegistry.set('init', {
        handler: index_js_1.initCommand,
...
First-time users should run: npx claude-flow@latest init --sparc`,
    ...
    exports.commandRegistry.set('start', {
        handler: start_js_1.startCommand,
    ...
    exports.commandRegistry.set('start-ui', {
        handler: async (args, flags) => {
            // Import and use the direct UI launcher
            const { launchUI } = await Promise.resolve().then(() => __importStar(require('./simple-commands/start-ui.js')));
            // Pass the full raw arguments from process.argv
            const fullArgs = process_1.default.argv.slice(3); // Skip node, script, and command
    ...
    exports.commandRegistry.set('memory', {
        handler: memory_js_1.memoryCommand,
    ...
    exports.commandRegistry.set('sparc', {
        handler: sparc_js_1.sparcCommand,
    ...
    exports.commandRegistry.set('agent', {
        handler: agent_js_1.agentCommand,
    ...
    exports.commandRegistry.set('task', {
        handler: task_js_1.taskCommand,
    ...
    exports.commandRegistry.set('config', {
        handler: config_js_1.configCommand,
    ...
    exports.commandRegistry.set('status', {
        handler: status_js_1.statusCommand,
        description: 'Show system status and health',
        usage: 'status [--verbose] [--json]',
        examples: ['status', 'status --verbose', 'status --json'],
    });
    exports.commandRegistry.set('mcp', {
        handler: mcp_js_1.mcpCommand,
        description: 'Manage MCP server and tools',
        usage: 'mcp <subcommand> [options]',
        examples: ['mcp status', 'mcp start --port 8080', 'mcp tools --verbose', 'mcp auth setup'],
    });
    exports.commandRegistry.set('monitor', {
        handler: monitor_js_1.monitorCommand,
    ...
    exports.commandRegistry.set('swarm', {
        handler: swarm_js_1.swarmCommand,
    ...
    exports.commandRegistry.set('hive-mind', {
        handler: hive_mind_js_1.hiveMindCommand,
...
Use 'hive-mind wizard' for interactive setup or 'hive-mind help' for full documentation.`,
    ...
    exports.commandRegistry.set('hive-mind-optimize', {
        handler: hive_mind_optimize_js_1.default,
...
Safety Features:
  ...
  • Rollback capability on errors`,
    ...
    exports.commandRegistry.set('swarm-metrics', {
        handler: async (args, flags) => {
            const subcommand = args[0];
            if (subcommand === 'fix') {
                return await (0, swarm_metrics_integration_js_1.fixTaskAttribution)();
            }
            else {
                return await (0, swarm_metrics_integration_js_1.showUnifiedMetrics)();
            }
        },
...
Use 'swarm-metrics fix' to automatically repair attribution issues.`,
    ...
    exports.commandRegistry.set('batch', {
        handler: batch_manager_js_1.batchManagerCommand,
...
Use with init command:
  ...
  claude-flow init --config batch-config.json --parallel`,
    ...
    exports.commandRegistry.set('github', {
        handler: github_js_1.githubCommand,
...
Advanced features:
  ...
  • Release pipeline orchestration with rollback capabilities`,
    ...
    exports.commandRegistry.set('training', {
        handler: training_js_1.trainingAction,
...
Improves task selection accuracy, agent performance prediction, and coordination efficiency.`,
    ...
    exports.commandRegistry.set('analysis', {
        handler: analysis_js_1.analysisAction,
...
Helps with performance optimization, cost management, and resource allocation.`,
    ...
    exports.commandRegistry.set('automation', {
        handler: automation_js_1.automationAction,
...
Provides optimal resource allocation and intelligent agent selection.`,
    ...
    exports.commandRegistry.set('coordination', {
        handler: coordination_js_1.coordinationAction,
...
Enables intelligent task distribution, agent synchronization, and shared memory coordination.`,
    ...
    exports.commandRegistry.set('hooks', {
        handler: hooks_js_1.hooksAction,
...
Enables automated preparation & cleanup, performance tracking, and coordination synchronization.`,
    ...
    exports.commandRegistry.set('hook-safety', {
        handler: hook_safety_js_1.hookSafetyCommand,
...
For more information: https://github.com/ruvnet/claude-flow/issues/166`,
    ...
    exports.commandRegistry.set('migrate-hooks', migrate_hooks_js_1.migrateHooksCommandConfig);
    exports.commandRegistry.set('fix-hook-variables', {
        handler: fix_hook_variables_js_1.fixHookVariablesCommand,
        ...fix_hook_variables_js_1.fixHookVariablesCommandConfig,
    });
    exports.commandRegistry.set('hive', {
        handler: async (args, flags) => {
            try {
                // Try to load the hive command module
                const { hiveAction } = await Promise.resolve().then(() => __importStar(require('./commands/hive.js')));
...
function registerCommand(name, command) {
    if (exports.commandRegistry.has(name)) {
        console.warn(`Command '${name}' already exists and will be overwritten`);
    }
    exports.commandRegistry.set(name, {
...
function getCommand(name) {
    return exports.commandRegistry.get(name);
}
// List all registered commands
function listCommands(includeHidden = false) {
    const commands = [];
    for (const [name, command] of exports.commandRegistry.entries()) {
...
function hasCommand(name) {
    return exports.commandRegistry.has(name);
}
// Execute a command
async function executeCommand(name, subArgs, flags) {
    const command = exports.commandRegistry.get(name);
    if (!command) {
...
function showCommandHelp(name) {
    const command = exports.commandRegistry.get(name);
    if (!command) {
        console.log(help_formatter_js_1.HelpFormatter.formatError(`Unknown command: ${name}`, 'claude-flow', 'claude-flow <command> [options]'));
        return;
    }
    ...
    const helpInfo = {
        ...
        description: help_formatter_js_1.HelpFormatter.stripFormatting(command.description),
    ...
    console.log(help_formatter_js_1.HelpFormatter.formatHelp(helpInfo));
}
