...
exports.advancedMemoryCommand = advancedMemoryCommand;
...
const advanced_memory_manager_js_1 = require("../../memory/advanced-memory-manager.js");
...
async function ensureMemoryManager() {
    if (!memoryManager) {
        memoryManager = new advanced_memory_manager_js_1.AdvancedMemoryManager({
...
async function advancedMemoryCommand(subArgs, flags) {
    ...
    try {
        ...
        const message = (0, error_handler_js_1.getErrorMessage)(error);
...
async function statsCommand(args, flags) {
    try {
        ...
        if (flags.format === 'json') {
            ...
            if (flags.export) {
                await node_fs_1.promises.writeFile(flags.export, JSON.stringify(output, null, 2));
