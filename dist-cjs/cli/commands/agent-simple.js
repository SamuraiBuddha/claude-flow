...
exports.agentHealth = exports.restartAgent = exports.startAgent = exports.terminateAgent = exports.agentInfo = exports.listAgents = exports.spawnAgent = exports.agentCommands = void 0;
const agent_manager_js_1 = require("../../agents/agent-manager.js");
const agent_registry_js_1 = require("../../agents/agent-registry.js");
...
async function initializeAgentSystem() {
    ...
    try {
        ...
        const memorySystem = new distributed_memory_js_1.DistributedMemorySystem({
            namespace: 'agents',
            distributed: false,
        ...
        agentRegistry = new agent_registry_js_1.AgentRegistry(memorySystem, 'agents');
    ...
    async info(args, options = {}) {
        try {
            ...
            if (!agent) {
                ...
                const similar = allAgents.filter((a) => a.id.id.includes(agentId) || a.name.toLowerCase().includes(agentId.toLowerCase()));
                if (similar.length > 0) {
...
exports.spawnAgent = exports.agentCommands.spawn, exports.listAgents = exports.agentCommands.list, exports.agentInfo = exports.agentCommands.info, exports.terminateAgent = exports.agentCommands.terminate, exports.startAgent = exports.agentCommands.start, exports.restartAgent = exports.agentCommands.restart, exports.agentHealth = exports.agentCommands.health;
