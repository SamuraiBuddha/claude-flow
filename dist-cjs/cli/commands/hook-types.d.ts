...
export type HookType = 'pre-task' | 'post-task' | 'pre-edit' | 'post-edit' | 'pre-command' | 'post-command' | 'session-start' | 'session-end' | 'session-restore' | 'pre-search' | 'notification' | 'performance' | 'memory-sync' | 'telemetry';
