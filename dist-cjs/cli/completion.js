...
exports.CompletionGenerator = void 0;
...
class CompletionGenerator {
    ...
    async generate(shell, install = false) {
        ...
        switch (detectedShell) {
            ...
            case 'fish':
                ...
                break;
            default:
                console.error(chalk_1.default.red(`Unsupported shell: ${detectedShell}`));
    ...
    async detectShell() {
        ...
        if (shell.includes('fish'))
            return 'fish';
        console.log(chalk_1.default.yellow('Could not detect shell, defaulting to bash'));
        return 'bash';
    }
    ...
    async installBashCompletion(script) {
        ...
        for (const path of possiblePaths) {
            try {
                ...
                await node_fs_1.promises.writeFile(path, script);
                console.log(chalk_1.default.green('✓ Bash completion installed'));
                console.log(`${chalk_1.default.white('Location:')} ${path}`);
                console.log(chalk_1.default.gray('Restart your shell or run: source ~/.bashrc'));
                return;
            }
            catch (error) {
                // Try next path
        ...
        console.error(chalk_1.default.red('Failed to install bash completion'));
        console.log(chalk_1.default.gray('You can manually save the completion script to a bash completion directory'));
    }
    async installZshCompletion(script) {
        ...
        for (const path of possiblePaths) {
            try {
                ...
                await Deno.mkdir(dir, { recursive: true });
                await node_fs_1.promises.writeFile(path, script);
                console.log(chalk_1.default.green('✓ Zsh completion installed'));
                console.log(`${chalk_1.default.white('Location:')} ${path}`);
                console.log(chalk_1.default.gray('Restart your shell or run: autoload -U compinit && compinit'));
                return;
            }
            catch (error) {
                // Try next path
        ...
        console.error(chalk_1.default.red('Failed to install zsh completion'));
        console.log(chalk_1.default.gray('You can manually save the completion script to your zsh completion directory'));
    }
    async installFishCompletion(script) {
        ...
        for (const path of possiblePaths) {
            try {
                ...
                await Deno.mkdir(dir, { recursive: true });
                await node_fs_1.promises.writeFile(path, script);
                console.log(chalk_1.default.green('✓ Fish completion installed'));
                console.log(`${chalk_1.default.white('Location:')} ${path}`);
                console.log(chalk_1.default.gray('Completions will be available in new fish sessions'));
                return;
            }
            catch (error) {
                // Try next path
        ...
        console.error(chalk_1.default.red('Failed to install fish completion'));
        console.log(chalk_1.default.gray('You can manually save the completion script to your fish completion directory'));
    }
}
exports.CompletionGenerator = CompletionGenerator;
