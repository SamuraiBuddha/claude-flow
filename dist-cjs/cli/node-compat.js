...
const isMainModule = (importMetaUrl) => {
    const __filename = (0, url_1.fileURLToPath)(importMetaUrl);
    return (0, path_1.normalize)(process_1.default.argv[1]) === (0, path_1.normalize)(__filename);
};
exports.isMainModule = isMainModule;
// Build information (Node.js equivalent of Deno.build)
exports.build = {
    os: process_1.default.platform === 'win32'
        ? 'windows'
        : process_1.default.platform === 'darwin'
            ? 'darwin'
            : process_1.default.platform === 'linux'
                ? 'linux'
...
exports.env = {
    ...
    set: (key, value) => {
        process_1.default.env[key] = value;
    },
