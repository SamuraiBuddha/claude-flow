...
exports.analysisAction = analysisAction;
const utils_js_1 = require("../utils.js");
async function analysisAction(subArgs, flags) {
    ...
    try {
        switch (subcommand) {
            ...
            case 'token-usage':
                ...
                break;
            default:
                (0, utils_js_1.printError)(`Unknown analysis command: ${subcommand}`);
                showAnalysisHelp();
        }
    }
    catch (err) {
        (0, utils_js_1.printError)(`Analysis command failed: ${err.message}`);
    }
}
async function bottleneckDetectCommand(subArgs, flags) {
    ...
    try {
        ...
        const analysisResult = await (0, utils_js_1.callRuvSwarmMCP)('benchmark_run', {
        ...
        if (analysisResult.success) {
            (0, utils_js_1.printSuccess)(`✅ Bottleneck analysis completed`);
            ...
            (0, utils_js_1.printError)(`Bottleneck analysis failed: ${analysisResult.error || 'Unknown error'}`);
        }
    }
    catch (err) {
        (0, utils_js_1.printError)(`Bottleneck analysis failed: ${err.message}`);
...
async function performanceReportCommand(subArgs, flags) {
    ...
    (0, utils_js_1.printSuccess)(`✅ Performance report generated`);
...
async function tokenUsageCommand(subArgs, flags) {
    ...
    (0, utils_js_1.printSuccess)(`✅ Token usage analysis completed`);
    console.log(`\n🔢 TOKEN USAGE SUMMARY:`);
