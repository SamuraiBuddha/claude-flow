...
exports.SwarmCommunication = void 0;
 ...
 */
class SwarmCommunication extends events_1.default {
    constructor(config = {}) {
        super();
        this.config = {
        ...
        this.encryptionKey = this.config.encryption ? crypto_1.default.randomBytes(32) : null;
        this._initialize();
    }
    /**
...
exports.SwarmCommunication = SwarmCommunication;
