...
exports.HiveMindCore = void 0;
const events_1 = __importDefault(require("events"));
const mcp_wrapper_js_1 = require("./mcp-wrapper.js");
const performance_optimizer_js_1 = require("./performance-optimizer.js");
/**
 * HiveMindCore - Main orchestration class
 */
class HiveMindCore extends events_1.default {
    constructor(config = {}) {
        super();
        this.config = {
            objective: '',
        ...
        this.mcpWrapper = new mcp_wrapper_js_1.MCPToolWrapper({
            parallel: true,
            timeout: this.config.taskTimeout * 60 * 1000,
        });
        // Initialize performance optimizer
        this.performanceOptimizer = new performance_optimizer_js_1.PerformanceOptimizer({
...
exports.HiveMindCore = HiveMindCore;
