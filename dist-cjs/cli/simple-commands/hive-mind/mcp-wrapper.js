...
exports.MCP_TOOLS = exports.MCPToolWrapper = void 0;
...
class MCPToolWrapper {
    ...
    async initializeMemoryStorage() {
        try {
            const { createDatabase, isSQLiteAvailable } = await Promise.resolve().then(() => __importStar(require('../../../memory/sqlite-wrapper.js')));
