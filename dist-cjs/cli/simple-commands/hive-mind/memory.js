...
exports.MemoryOptimizer = exports.CollectiveMemory = void 0;
 ...
 */
class CollectiveMemory extends events_1.default {
    constructor(config = {}) {
        super();
        ...
        this.config = {
            ...
            dbPath: config.dbPath || path_1.default.join(process.cwd(), '.hive-mind', 'hive.db'),
