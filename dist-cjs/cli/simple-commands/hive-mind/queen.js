...
exports.QueenCoordinator = void 0;
 ...
 */
class QueenCoordinator extends events_1.default {
    constructor(config = {}) {
        super();
        this.config = {
    ...
    _selectStrategy(objective) {
        ...
        if (objective.toLowerCase().includes('iterative') ||
    ...
    _optimizeWorkerAssignment(tasks, workerGroups) {
        ...
        tasks.forEach((task) => {
            ...
            if (availableWorkers.length > 0) {
                ...
                const workerIndex = Object.keys(assignments).filter((t) => assignments[t].type === bestWorkerType).length %
...
exports.QueenCoordinator = QueenCoordinator;
