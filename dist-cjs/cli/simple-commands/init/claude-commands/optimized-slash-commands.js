...
exports.createOptimizedClaudeSlashCommands = createOptimizedClaudeSlashCommands;
const optimized_sparc_commands_js_1 = require("./optimized-sparc-commands.js");
const optimized_claude_flow_commands_js_1 = require("./optimized-claude-flow-commands.js");
...
async function createOptimizedClaudeSlashCommands(workingDir, selectedModes = null) {
    try {
        ...
        try {
            ...
            const commandPromises = modesToCreate.map(async (mode) => {
                ...
                const commandContent = (0, optimized_sparc_commands_js_1.createOptimizedSparcSlashCommand)(mode);
            ...
            const mainSparcCommand = (0, optimized_sparc_commands_js_1.createOptimizedMainSparcCommand)(roomodes.customModes);
            ...
            const copyResults = await (0, template_copier_js_1.copyTemplates)(workingDir, optimizedOptions);
        ...
        await (0, optimized_claude_flow_commands_js_1.createOptimizedClaudeFlowCommands)(workingDir);
...
//# sourceMappingURL=optimized-slash-commands.js.map