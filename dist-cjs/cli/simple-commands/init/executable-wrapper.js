...
exports.createLocalExecutable = createLocalExecutable;
const promises_1 = require("fs/promises");
const os_1 = require("os");
async function createLocalExecutable(workingDir, dryRun = false) {
    try {
...
`;
            ...
            if (!dryRun) {
                await (0, promises_1.writeFile)(`${workingDir}/claude-flow.cmd`, wrapperScript, 'utf8');
...
`;
            ...
            if (!dryRun) {
                await (0, promises_1.writeFile)(`${workingDir}/claude-flow`, wrapperScript, 'utf8');
                // Make it executable
                await (0, promises_1.chmod)(`${workingDir}/claude-flow`, 0o755);
