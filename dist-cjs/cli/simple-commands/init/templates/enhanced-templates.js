...
exports.COMMAND_STRUCTURE = void 0;
exports.createEnhancedClaudeMd = createEnhancedClaudeMd;
exports.createEnhancedSettingsJson = createEnhancedSettingsJson;
exports.createWrapperScript = createWrapperScript;
exports.createCommandDoc = createCommandDoc;
exports.createHelperScript = createHelperScript;
...
const loadTemplate = (filename) => {
    try {
        return (0, fs_1.readFileSync)((0, path_1.join)(__dirname, filename), 'utf8');
    }
    catch (error) {
...
function createEnhancedClaudeMdFallback() {
    ...
    try {
        return (0, fs_1.readFileSync)((0, path_1.join)(__dirname, 'CLAUDE.md'), 'utf8');
    }
    catch (error) {
