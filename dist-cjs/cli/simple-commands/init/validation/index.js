...
const pre_init_validator_js_1 = require("./pre-init-validator.js");
const post_init_validator_js_1 = require("./post-init-validator.js");
const config_validator_js_1 = require("./config-validator.js");
const mode_validator_js_1 = require("./mode-validator.js");
const health_checker_js_1 = require("./health-checker.js");
/**
...
class ValidationSystem {
    constructor(workingDir) {
        ...
        this.preInitValidator = new pre_init_validator_js_1.PreInitValidator(workingDir);
        this.postInitValidator = new post_init_validator_js_1.PostInitValidator(workingDir);
        this.configValidator = new config_validator_js_1.ConfigValidator(workingDir);
        this.modeValidator = new mode_validator_js_1.ModeValidator(workingDir);
        this.healthChecker = new health_checker_js_1.HealthChecker(workingDir);
    }
    /**
 ...
 */
async function runFullValidation(workingDir, options = {}) {
