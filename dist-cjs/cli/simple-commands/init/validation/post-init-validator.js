...
exports.PostInitValidator = void 0;
class PostInitValidator {
        ...
        for (const item of itemsToCheck) {
            ...
            try {
                ...
                if (actualMode !== expectedMode) {
                    result.warnings.push(`Incorrect permissions on ${item.path}: ` +
...
exports.PostInitValidator = PostInitValidator;
//# sourceMappingURL=post-init-validator.js.map