...
exports.EnhancedProcessUI = void 0;
exports.launchEnhancedUI = launchEnhancedUI;
...
const swarm_webui_integration_js_1 = __importDefault(require("./swarm-webui-integration.js"));
...
class EnhancedProcessUI {
    constructor() {
        ...
        this.swarmIntegration = new swarm_webui_integration_js_1.default(this);
    ...
    async start() {
        ...
        console.clear();
        // Show welcome
        (0, utils_js_1.printSuccess)('🧠 Claude-Flow Process Management UI v1.0.71');
    ...
    async handleInput() {
        const terminal = runtime_detector_js_1.compat.terminal;
        ...
        switch (input) {
            ...
            case 'quit':
                this.running = false;
                console.clear();
                (0, utils_js_1.printSuccess)('Goodbye!');
...
exports.EnhancedProcessUI = EnhancedProcessUI;
async function launchEnhancedUI() {
