    ...
    try {
        ...
        try {
            ...
            try {
                ...
                const pmModule = await Promise.resolve().then(() => __importStar(require('../../../dist/cli/commands/start/process-manager.js')));
                const puiModule = await Promise.resolve().then(() => __importStar(require('../../../dist/cli/commands/start/process-ui-simple.js')));
                ...
                const pmModule = await Promise.resolve().then(() => __importStar(require('../commands/start/process-manager.ts')));
                const puiModule = await Promise.resolve().then(() => __importStar(require('../commands/start/process-ui-simple.ts')));
                ProcessManager = pmModule.ProcessManager;
                ProcessUI = puiModule.ProcessUI;
            }
