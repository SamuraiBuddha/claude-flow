...
exports.SwarmWebUIIntegration = void 0;
const runtime_detector_js_1 = require("../runtime-detector.js");
class SwarmWebUIIntegration {
    constructor(ui) {
        this.ui = ui;
    ...
    async checkSwarmAvailability() {
        try {
            ...
            return runtime_detector_js_1.compat.getEnv('CLAUDE_FLOW_SWARM_ENABLED') === 'true';
        }
        catch (err) {
            return false;
        }
...
exports.SwarmWebUIIntegration = SwarmWebUIIntegration;
exports.default = SwarmWebUIIntegration;
//# sourceMappingURL=swarm-webui-integration.js.map