...
function startWebUI(host, port) {
  ...
  `;
    ...
    app.post('/api/command', express_1.default.json(), (req, res) => {
...
`;
        ...
        const cliPath = path_1.default.join(rootDir, 'bin', 'claude-flow');
        // Spawn the command
        const child = (0, child_process_1.spawn)('node', [path_1.default.join(rootDir, 'src/cli/simple-cli.js'), ...cmdArgs], {
