...
exports.handleNonInteractive = handleNonInteractive;
exports.warnNonInteractive = warnNonInteractive;
exports.checkNonInteractiveAuth = checkNonInteractiveAuth;
/**
 ...
 */
function handleNonInteractive(commandName, interactiveFn, nonInteractiveFn) {
    return async (...args) => {
 ...
 */
function warnNonInteractive(commandName) {
    if (!isInteractive()) {
 ...
 */
function checkNonInteractiveAuth() {
    if (!isInteractive()) {
