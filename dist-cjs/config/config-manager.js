...
exports.configManager = exports.ConfigManager = exports.ConfigError = void 0;
...
class ConfigManager {
    ...
    constructor() {
        ...
        this.userConfigDir = path_1.default.join(os_1.default.homedir(), '.claude-flow');
    }
    /**
    ...
    async createDefaultConfig(configPath) {
        ...
        await fs_1.promises.writeFile(configPath, content, 'utf8');
    ...
    async backup(path) {
        ...
        const content = JSON.stringify(this.config, null, 2);
        await fs_1.promises.writeFile(backupPath, content, 'utf8');
