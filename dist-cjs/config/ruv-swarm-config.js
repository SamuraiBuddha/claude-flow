...
exports.RuvSwarmConfigManager = exports.defaultRuvSwarmConfig = void 0;
exports.getRuvSwarmConfigManager = getRuvSwarmConfigManager;
...
class RuvSwarmConfigManager {
    ...
    constructor(logger, configPath) {
        this.logger = logger;
        this.configPath = configPath || (0, path_1.join)(process.cwd(), '.claude', 'ruv-swarm-config.json');
    ...
    loadConfig() {
        try {
            if ((0, fs_1.existsSync)(this.configPath)) {
                ...
                // Merge with defaults
                const mergedConfig = (0, helpers_js_1.deepMerge)(exports.defaultRuvSwarmConfig, userConfig);
        ...
        return { ...exports.defaultRuvSwarmConfig };
    }
    /**
    ...
    saveConfig() {
        try {
            const configDir = (0, path_1.join)(this.configPath, '..');
            // Ensure config directory exists
            if (!(0, fs_1.existsSync)(configDir)) {
                const fs = require('fs');
                fs.mkdirSync(configDir, { recursive: true });
            }
            (0, fs_1.writeFileSync)(this.configPath, JSON.stringify(this.config, null, 2), 'utf-8');
    ...
    updateConfig(updates) {
        this.config = (0, helpers_js_1.deepMerge)(this.config, updates);
        this.saveConfig();
     ...
     */
    resetConfig() {
        this.config = { ...exports.defaultRuvSwarmConfig };
        this.saveConfig();
...
exports.RuvSwarmConfigManager = RuvSwarmConfigManager;
/**
...
exports.default = {
    ...
    defaultRuvSwarmConfig: exports.defaultRuvSwarmConfig,
};
