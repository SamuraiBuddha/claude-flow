...
exports.AdvancedTaskScheduler = exports.AffinitySchedulingStrategy = exports.LeastLoadedSchedulingStrategy = exports.RoundRobinSchedulingStrategy = exports.CapabilitySchedulingStrategy = void 0;
...
exports.CapabilitySchedulingStrategy = CapabilitySchedulingStrategy;
/**
...
exports.RoundRobinSchedulingStrategy = RoundRobinSchedulingStrategy;
/**
...
exports.LeastLoadedSchedulingStrategy = LeastLoadedSchedulingStrategy;
/**
...
exports.AffinitySchedulingStrategy = AffinitySchedulingStrategy;
/**
 * Advanced task scheduler with multiple strategies
 */
class AdvancedTaskScheduler extends scheduler_js_1.TaskScheduler {
    strategies = new Map();
    ...
    constructor(config, eventBus, logger) {
        ...
        this.workStealing = new work_stealing_js_1.WorkStealingCoordinator({
            enabled: true,
            stealThreshold: 3,
            maxStealBatch: 2,
            stealInterval: 5000,
        }, eventBus, logger);
        this.dependencyGraph = new dependency_graph_js_1.DependencyGraph(logger);
        const cbConfig = {
            failureThreshold: 3,
            successThreshold: 2,
            timeout: 30000,
        ...
        this.circuitBreakers = new circuit_breaker_js_1.CircuitBreakerManager(cbConfig, logger, eventBus);
    ...
    async completeTask(taskId, result) {
        ...
        for (const readyTaskId of readyTasks) {
            ...
            if (readyTask) {
                this.eventBus.emit(types_js_1.SystemEvents.TASK_CREATED, { task: readyTask });
            }
        }
    }
    /**
    ...
    setupAdvancedEventHandlers() {
        ...
        this.eventBus.on(types_js_1.SystemEvents.TASK_ASSIGNED, async (data) => {
            const { agentId } = data;
            const taskCount = await this.getAgentTaskCount(agentId);
            this.workStealing.updateAgentWorkload(agentId, { taskCount });
        });
...
exports.AdvancedTaskScheduler = AdvancedTaskScheduler;
