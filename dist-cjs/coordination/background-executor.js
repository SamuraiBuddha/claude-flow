...
exports.BackgroundExecutor = void 0;
...
class BackgroundExecutor extends node_events_1.EventEmitter {
    logger;
    config;
    tasks;
    processes;
    ...
    constructor(config = {}) {
        super();
        this.logger = new logger_js_1.Logger('BackgroundExecutor');
        this.config = {
    ...
    async submitTask(type, command, args = [], options = {}) {
        const taskId = (0, helpers_js_1.generateId)('bgtask');
        const task = {
            id: taskId,
            type,
            command,
    ...
    async executeTask(task) {
        try {
            ...
            // Spawn process
            const childProcess = (0, node_child_process_1.spawn)(task.command, task.args, {
...
exports.BackgroundExecutor = BackgroundExecutor;
