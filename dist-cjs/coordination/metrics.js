...
exports.CoordinationMetricsCollector = void 0;
...
class CoordinationMetricsCollector {
    ...
    setupEventHandlers() {
        // Task events
        this.eventBus.on(types_js_1.SystemEvents.TASK_CREATED, () => {
        ...
        this.eventBus.on(types_js_1.SystemEvents.TASK_COMPLETED, (data) => {
        ...
        this.eventBus.on(types_js_1.SystemEvents.TASK_FAILED, (data) => {
            this.counters.failedTasks++;
            this.gauges.activeTasks = Math.max(0, this.gauges.activeTasks - 1);
            this.taskStartTimes.delete(data.taskId);
            this.recordMetric('task.failed', 1);
        });
        this.eventBus.on(types_js_1.SystemEvents.TASK_CANCELLED, (data) => {
        ...
        this.eventBus.on(types_js_1.SystemEvents.RESOURCE_RELEASED, (data) => {
        ...
        // Deadlock events
        this.eventBus.on(types_js_1.SystemEvents.DEADLOCK_DETECTED, () => {
            this.counters.deadlockCount++;
            this.recordMetric('deadlock.detected', 1);
        });
        // Message events
        this.eventBus.on(types_js_1.SystemEvents.MESSAGE_SENT, (data) => {
            this.counters.messagesSent++;
            this.messageStartTimes.set(data.message.id, new Date());
            this.recordMetric('message.sent', 1);
        });
        this.eventBus.on(types_js_1.SystemEvents.MESSAGE_RECEIVED, (data) => {
        ...
        // Error events
        this.eventBus.on(types_js_1.SystemEvents.SYSTEM_ERROR, () => {
...
exports.CoordinationMetricsCollector = CoordinationMetricsCollector;
