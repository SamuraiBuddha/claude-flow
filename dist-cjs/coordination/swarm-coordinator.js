...
const swarm_monitor_js_1 = require("./swarm-monitor.js");
const manager_js_1 = require("../memory/manager.js");
class SwarmCoordinator extends node_events_1.EventEmitter {
    logger;
    config;
    agents;
    objectives;
    ...
    constructor(config = {}) {
        super();
        this.logger = new logger_js_1.Logger('SwarmCoordinator');
        this.config = {
            maxAgents: 10,
        ...
        if (this.config.enableMonitoring) {
            this.monitor = new swarm_monitor_js_1.SwarmMonitor({
                updateInterval: 1000,
                enableAlerts: true,
                enableHistory: true,
            });
