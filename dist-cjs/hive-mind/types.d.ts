...
export type AgentCapability = 'task_management' | 'resource_allocation' | 'consensus_building' | 'information_gathering' | 'pattern_recognition' | 'knowledge_synthesis' | 'code_generation' | 'refactoring' | 'debugging' | 'data_analysis' | 'performance_metrics' | 'bottleneck_detection' | 'system_design' | 'architecture_patterns' | 'integration_planning' | 'test_generation' | 'quality_assurance' | 'edge_case_detection' | 'code_review' | 'standards_enforcement' | 'best_practices' | 'performance_optimization' | 'resource_optimization' | 'algorithm_improvement' | 'documentation_generation' | 'api_docs' | 'user_guides' | 'system_monitoring' | 'health_checks' | 'alerting' | 'domain_expertise' | 'custom_capabilities' | 'problem_solving';
...
export type MessageType = 'direct' | 'broadcast' | 'consensus' | 'query' | 'response' | 'notification' | 'task_assignment' | 'progress_update' | 'coordination' | 'channel' | 'task_failed' | 'task_completed';
