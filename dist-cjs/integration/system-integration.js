...
class SystemIntegration {
    ...
    async initializeCore(config) {
        ...
        try {
            ...
            try {
                const { Orchestrator } = await Promise.resolve().then(() => __importStar(require('../core/orchestrator-fixed.js')));
    ...
    async initializeAgentsAndCoordination() {
        ...
        try {
            ...
            try {
                ...
                this.agentManager = new AgentManager({}, this.logger, this.eventBus, this.memoryManager);
                ...
                const { MockAgentManager } = await Promise.resolve().then(() => __importStar(require('./mock-components.js')));
            ...
            try {
                const { SwarmCoordinator } = await Promise.resolve().then(() => __importStar(require('../coordination/swarm-coordinator.js')));
                ...
                const { MockSwarmCoordinator } = await Promise.resolve().then(() => __importStar(require('./mock-components.js')));
    ...
    async initializeTaskManagement() {
        ...
        try {
            ...
            try {
                const { TaskEngine } = await Promise.resolve().then(() => __importStar(require('../task/engine.js')));
                ...
                const { MockTaskEngine } = await Promise.resolve().then(() => __importStar(require('./mock-components.js')));
    ...
    async initializeMonitoringAndMcp() {
        ...
        try {
            ...
            try {
                const { RealTimeMonitor } = await Promise.resolve().then(() => __importStar(require('../monitoring/real-time-monitor.js')));
                this.monitor = new RealTimeMonitor({}, this.logger, this.eventBus, this.memoryManager);
                ...
                const { MockRealTimeMonitor } = await Promise.resolve().then(() => __importStar(require('./mock-components.js')));
            ...
            try {
                const { MCPServer } = await Promise.resolve().then(() => __importStar(require('../mcp/server.js')));
                this.mcpServer = new MCPServer({ transport: 'stdio' }, this.eventBus, this.logger);
                ...
                const { MockMcpServer } = await Promise.resolve().then(() => __importStar(require('./mock-components.js')));
    ...
    setupEventHandlers() {
        ...
        this.eventBus.on('component:status', (event) => {
            const e = event;
            this.updateComponentStatus(e.component, e.status, e.message);
        });
        // Error handling
        this.eventBus.on('system:error', (event) => {
            const e = event;
            this.logger.error(`System Error in ${e.component}:`, e.error);
            this.updateComponentStatus(e.component, 'unhealthy', e.error.message);
        });
        // Performance monitoring
        this.eventBus.on('performance:metric', (event) => {
            const e = event;
            this.logger.debug(`Performance Metric: ${e.metric} = ${e.value}`);
        });
    }
    /**
