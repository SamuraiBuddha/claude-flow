...
exports.StatusDashboard = void 0;
const node_events_1 = require("node:events");
const chalk_1 = __importDefault(require("chalk"));
const cli_table3_1 = __importDefault(require("cli-table3"));
// ===== Status Dashboard Class =====
class StatusDashboard extends node_events_1.EventEmitter {
    config;
    specs = new Map();
    plans = new Map();
    tasks = new Map();
    ...
    renderTable() {
        ...
        const lines = [];
        // Header
        lines.push(chalk_1.default.cyan.bold('SpecKit Status Dashboard'));
        ...
        lines.push(chalk_1.default.white.bold('System Overview'));
        lines.push(`  ${chalk_1.default.white('Status:')} ${healthColor(overview.health.toUpperCase())}`);
        lines.push(`  ${chalk_1.default.white('Uptime:')} ${this.formatDuration(overview.uptime)}`);
        lines.push('');
        // Specs Summary
        lines.push(chalk_1.default.cyan.bold('Specifications'));
        const specTable = new cli_table3_1.default({
            head: ['Status', 'Count'],
            colWidths: [20, 15],
        });
        specTable.push(['Total', overview.specs.total.toString()], ['Draft', overview.specs.draft.toString()], ['Approved', chalk_1.default.green(overview.specs.approved.toString())], ['Implemented', chalk_1.default.blue(overview.specs.implemented.toString())]);
        lines.push(specTable.toString());
        lines.push('');
        // Plans Summary
        lines.push(chalk_1.default.cyan.bold('Plans'));
        const planTable = new cli_table3_1.default({
            head: ['Status', 'Count'],
            colWidths: [20, 15],
        });
        planTable.push(['Total', overview.plans.total.toString()], ['Active', chalk_1.default.cyan(overview.plans.active.toString())], ['Completed', chalk_1.default.green(overview.plans.completed.toString())], ['Blocked', overview.plans.blocked > 0 ? chalk_1.default.red(overview.plans.blocked.toString()) : '0']);
        lines.push(planTable.toString());
        lines.push('');
        // Tasks Summary
        lines.push(chalk_1.default.cyan.bold('Tasks'));
        const taskTable = new cli_table3_1.default({
            head: ['Status', 'Count'],
            colWidths: [20, 15],
        });
        taskTable.push(['Total', overview.tasks.total.toString()], ['Pending', chalk_1.default.gray(overview.tasks.pending.toString())], ['Running', chalk_1.default.cyan(overview.tasks.running.toString())], ['Completed', chalk_1.default.green(overview.tasks.completed.toString())], ['Failed', overview.tasks.failed > 0 ? chalk_1.default.red(overview.tasks.failed.toString()) : '0']);
        lines.push(taskTable.toString());
        lines.push('');
        // Agents Summary
        lines.push(chalk_1.default.cyan.bold('Agents'));
        const agentTable = new cli_table3_1.default({
            head: ['Status', 'Count'],
            colWidths: [20, 15],
        });
        agentTable.push(['Total', overview.agents.total.toString()], ['Idle', chalk_1.default.gray(overview.agents.idle.toString())], ['Busy', chalk_1.default.cyan(overview.agents.busy.toString())], ['Error', overview.agents.error > 0 ? chalk_1.default.red(overview.agents.error.toString()) : '0']);
        lines.push(agentTable.toString());
        lines.push('');
        // Warnings and Errors
        if (this.config.showWarnings && overview.warnings.length > 0) {
            lines.push(chalk_1.default.yellow.bold('Warnings'));
        ...
        if (this.config.showErrors && overview.errors.length > 0) {
            lines.push(chalk_1.default.red.bold('Errors'));
            for (const error of overview.errors) {
                lines.push(`  ${chalk_1.default.red('x')} ${error}`);
            }
            lines.push('');
        }
        ...
        if (!this.config.compactMode) {
            ...
            if (runningTasks.length > 0) {
                lines.push(chalk_1.default.cyan.bold('Active Tasks'));
                const activeTable = new cli_table3_1.default({
            ...
            if (busyAgents.length > 0) {
                lines.push(chalk_1.default.cyan.bold('Busy Agents'));
                const busyTable = new cli_table3_1.default({
...
exports.StatusDashboard = StatusDashboard;
