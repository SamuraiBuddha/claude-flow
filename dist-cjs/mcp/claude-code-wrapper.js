...
exports.ClaudeCodeMCPWrapper = void 0;
const index_js_1 = require("@modelcontextprotocol/sdk/server/index.js");
const stdio_js_1 = require("@modelcontextprotocol/sdk/server/stdio.js");
const types_js_1 = require("@modelcontextprotocol/sdk/types.js");
const path = __importStar(require("path"));
const url_1 = require("url");
const sparc_modes_js_1 = require("./sparc-modes.js");
...
async function executeSparcMode(mode, task, tools, context) {
...
class ClaudeCodeMCPWrapper {
    ...
    claudeCodeMCP; // Reference to Claude Code MCP client
    constructor() {
    ...
    async loadSparcModes() {
        try {
            const modes = await (0, sparc_modes_js_1.loadSparcModes)();
            modes.forEach((mode) => {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => this.handleToolCall(request.params.name, request.params.arguments || {}));
    }
    async getTools() {
        const tools = [];
    ...
    async handleSparcTool(toolName, args) {
        ...
        try {
            const result = await executeSparcMode(mode, args.task, sparcMode.tools || [], args.context || {});
            return {
                content: [
                    {
                        type: 'text',
    ...
    planSwarmAgents(objective, strategy, maxAgents) {
        ...
        switch (strategy) {
            ...
            case 'development':
                ...
                break;
            case 'analysis':
                agents.push({ id: generateId(), mode: 'analyst', task: `Analyze: ${objective}`, status: 'pending' }, {
                    id: generateId(),
                    mode: 'optimizer',
...
exports.ClaudeCodeMCPWrapper = ClaudeCodeMCPWrapper;
