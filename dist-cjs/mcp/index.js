...
const orchestration_integration_js_1 = require("./orchestration-integration.js");
// Core MCP Server
var server_js_2 = require("./server.js");
Object.defineProperty(exports, "MCPServer", { enumerable: true, get: function () { return server_js_2.MCPServer; } });
// Lifecycle Management
var lifecycle_manager_js_2 = require("./lifecycle-manager.js");
Object.defineProperty(exports, "MCPLifecycleManager", { enumerable: true, get: function () { return lifecycle_manager_js_2.MCPLifecycleManager; } });
Object.defineProperty(exports, "LifecycleState", { enumerable: true, get: function () { return lifecycle_manager_js_2.LifecycleState; } });
...
// Protocol Management
var protocol_manager_js_2 = require("./protocol-manager.js");
Object.defineProperty(exports, "MCPProtocolManager", { enumerable: true, get: function () { return protocol_manager_js_2.MCPProtocolManager; } });
...
var performance_monitor_js_2 = require("./performance-monitor.js");
Object.defineProperty(exports, "MCPPerformanceMonitor", { enumerable: true, get: function () { return performance_monitor_js_2.MCPPerformanceMonitor; } });
// Orchestration Integration
var orchestration_integration_js_2 = require("./orchestration-integration.js");
Object.defineProperty(exports, "MCPOrchestrationIntegration", { enumerable: true, get: function () { return orchestration_integration_js_2.MCPOrchestrationIntegration; } });
...
class MCPIntegrationFactory {
    ...
    static async createIntegration(config) {
        ...
        const integration = new orchestration_integration_js_1.MCPOrchestrationIntegration(mcpConfig, {
            enabledIntegrations: {
                orchestrator: true,
                swarm: true,
                agents: true,
    ...
    static async createStandaloneServer(config) {
        ...
        const server = new server_js_1.MCPServer(mcpConfig, eventBus, logger);
        let lifecycleManager;
        let performanceMonitor;
        if (enableLifecycleManagement) {
            lifecycleManager = new lifecycle_manager_js_1.MCPLifecycleManager(mcpConfig, logger, () => server);
        }
        if (enablePerformanceMonitoring) {
            performanceMonitor = new performance_monitor_js_1.MCPPerformanceMonitor(logger);
        }
        return {
            server,
            lifecycleManager,
    ...
    static async createDevelopmentSetup(logger) {
        ...
        const protocolManager = new protocol_manager_js_1.MCPProtocolManager(logger);
        return {
            server,
