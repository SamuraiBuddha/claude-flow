...
class MCPIntegration {
    ...
    async connectToClaudeCode() {
        try {
            ...
            const claudeCodeProcess = (0, child_process_1.spawn)('npx', ['-y', '@anthropic/claude-code', 'mcp'], {
...
function injectClaudeCodeClient(wrapper, client) {
    ...
    wrapper.forwardToClaudeCode = async function (toolName, args) {
        try {
            // callTool expects params object with name and arguments properties
            // Use type assertion to access callTool method from Client class
