...
exports.createRuvSwarmTools = createRuvSwarmTools;
exports.isRuvSwarmAvailable = isRuvSwarmAvailable;
exports.getRuvSwarmCapabilities = getRuvSwarmCapabilities;
...
async function executeRuvSwarmCommand(command, args = [], context, logger) {
    try {
        ...
        const result = await (0, helpers_js_1.execAsync)(fullCommand, { cwd: workDir });
