...
class HttpTransport {
    ...
    setupRoutes() {
        ...
        const currentFilePath = typeof import.meta?.url !== 'undefined'
            ? (0, node_url_1.fileURLToPath)(import.meta.url)
            : __filename;
        const currentDirPath = (0, node_path_1.dirname)(currentFilePath);
        const consoleDir = (0, node_path_1.join)(currentDirPath, '../../ui/console');
