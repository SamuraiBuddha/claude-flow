...
exports.SqliteMemoryStore = exports.memoryStore = void 0;
...
class SqliteMemoryStore {
    ...
    _getMemoryDirectory() {
        ...
        return path_1.default.join(process.cwd(), '.swarm');
    }
    ...
    async initialize() {
        ...
        try {
            ...
            await fs_1.promises.mkdir(this.options.directory, { recursive: true });
            // Open database
            const dbPath = path_1.default.join(this.options.directory, this.options.dbName);
            this.db = await (0, sqlite_wrapper_js_1.createDatabase)(dbPath);
...
exports.memoryStore = new SqliteMemoryStore();
exports.default = SqliteMemoryStore;
