...
class SwarmMemoryManager extends node_events_1.EventEmitter {
    ...
    constructor(config = {}) {
        super();
        this.logger = new logger_js_1.Logger('SwarmMemoryManager');
        this.config = {
            namespace: 'swarm',
        ...
        this.baseMemory = new manager_js_1.MemoryManager({
            backend: 'sqlite',
    ...
    async shareMemory(entryId, targetAgentId) {
        ...
        const sharedEntry = {
            ...entry,
            id: (0, helpers_js_1.generateId)('mem'),
            metadata: {
                ...entry.metadata,
                originalId: entryId,
    ...
    async createKnowledgeBase(name, description, domain, expertise) {
        const kbId = (0, helpers_js_1.generateId)('kb');
        const knowledgeBase = {
            id: kbId,
            name,
            description,
