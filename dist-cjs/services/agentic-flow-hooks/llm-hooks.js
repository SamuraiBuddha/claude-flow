...
exports.llmRetryHook = exports.llmErrorHook = exports.postLLMCallHook = exports.preLLMCallHook = void 0;
exports.registerLLMHooks = registerLLMHooks;
const hook_manager_js_1 = require("./hook-manager.js");
// ===== Pre-LLM Call Hook =====
exports.preLLMCallHook = {
...
function registerLLMHooks() {
    hook_manager_js_1.agenticHookManager.register(exports.preLLMCallHook);
    hook_manager_js_1.agenticHookManager.register(exports.postLLMCallHook);
    hook_manager_js_1.agenticHookManager.register(exports.llmErrorHook);
    hook_manager_js_1.agenticHookManager.register(exports.llmRetryHook);
}
