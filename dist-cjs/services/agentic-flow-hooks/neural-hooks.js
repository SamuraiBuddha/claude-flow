...
exports.neuralAdaptationHook = exports.neuralPredictionHook = exports.neuralPatternDetectedHook = exports.postNeuralTrainHook = exports.preNeuralTrainHook = void 0;
exports.registerNeuralHooks = registerNeuralHooks;
const hook_manager_js_1 = require("./hook-manager.js");
// ===== Pre-Neural Train Hook =====
exports.preNeuralTrainHook = {
...
exports.neuralPatternDetectedHook = {
...
function registerNeuralHooks() {
    hook_manager_js_1.agenticHookManager.register(exports.preNeuralTrainHook);
    hook_manager_js_1.agenticHookManager.register(exports.postNeuralTrainHook);
    hook_manager_js_1.agenticHookManager.register(exports.neuralPatternDetectedHook);
    hook_manager_js_1.agenticHookManager.register(exports.neuralPredictionHook);
    hook_manager_js_1.agenticHookManager.register(exports.neuralAdaptationHook);
}
