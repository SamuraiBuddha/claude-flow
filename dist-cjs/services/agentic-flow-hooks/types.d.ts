 ...
 */
import type { HookType } from '../../cli/commands/hook-types.js';
...
export type LLMHookType = 'pre-llm-call' | 'post-llm-call' | 'llm-error' | 'llm-retry' | 'llm-fallback' | 'llm-cache-hit' | 'llm-cache-miss';
...
export type MemoryHookType = 'pre-memory-store' | 'post-memory-store' | 'pre-memory-retrieve' | 'post-memory-retrieve' | 'memory-sync' | 'memory-persist' | 'memory-expire';
...
export type NeuralHookType = 'pre-neural-train' | 'post-neural-train' | 'neural-pattern-detected' | 'neural-prediction' | 'neural-adaptation';
...
export type PerformanceHookType = 'performance-metric' | 'performance-bottleneck' | 'performance-optimization' | 'performance-threshold';
...
export type WorkflowHookType = 'workflow-start' | 'workflow-step' | 'workflow-decision' | 'workflow-complete' | 'workflow-error';
...
export type AgenticHookType = LLMHookType | MemoryHookType | NeuralHookType | PerformanceHookType | WorkflowHookType | HookType;
export type HookHandler = (payload: HookPayload, context: AgenticHookContext) => Promise<HookHandlerResult>;
export type HookPayload = LLMHookPayload | MemoryHookPayload | NeuralHookPayload | PerformanceHookPayload | WorkflowHookPayload;
