...
exports.TaskExecutorV2 = void 0;
const node_child_process_1 = require("node:child_process");
const helpers_js_1 = require("../utils/helpers.js");
const environment_detector_js_1 = require("../cli/utils/environment-detector.js");
const executor_js_1 = require("./executor.js");
class TaskExecutorV2 extends executor_js_1.TaskExecutor {
    environment = (0, environment_detector_js_1.detectExecutionEnvironment)();
    constructor(config = {}) {
        super(config);
    ...
    async executeClaudeTask(task, agent, claudeOptions = {}) {
        ...
        const enhancedOptions = (0, environment_detector_js_1.applySmartDefaults)(claudeOptions, this.environment);
        ...
        try {
            return await this.executeClaudeWithTimeoutV2((0, helpers_js_1.generateId)('claude-execution'), task, agent, await this.createExecutionContext(task, agent), enhancedOptions);
        }
        catch (error) {
            ...
            if (this.isInteractiveError(error) && enhancedOptions.retryOnInteractiveError) {
                ...
                return await this.executeClaudeWithTimeoutV2((0, helpers_js_1.generateId)('claude-execution-retry'), task, agent, await this.createExecutionContext(task, agent), enhancedOptions);
            }
            throw error;
        }
    }
...
exports.TaskExecutorV2 = TaskExecutorV2;
exports.default = TaskExecutorV2;
