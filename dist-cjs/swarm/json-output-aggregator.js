...
exports.SwarmJsonOutputAggregator = void 0;
const events_1 = require("events");
const node_fs_1 = require("node:fs");
const logger_js_1 = require("../core/logger.js");
class SwarmJsonOutputAggregator extends events_1.EventEmitter {
    logger;
    swarmId;
    objective;
    startTime;
    ...
    constructor(swarmId, objective, configuration = {}) {
        ...
        this.logger = new logger_js_1.Logger({ level: 'info', format: 'json', destination: 'console' }, { component: 'SwarmJsonAggregator' });
...
exports.SwarmJsonOutputAggregator = SwarmJsonOutputAggregator;
