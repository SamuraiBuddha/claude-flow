...
exports.OptimizedExecutor = void 0;
...
const ttl_map_js_1 = require("./ttl-map.js");
const circular_buffer_js_1 = require("./circular-buffer.js");
const p_queue_1 = __importDefault(require("p-queue"));
class OptimizedExecutor extends node_events_1.EventEmitter {
    config;
    logger;
    connectionPool;
    fileManager;
    ...
    constructor(config = {}) {
        ...
        this.logger = new logger_js_1.Logger(loggerConfig, { component: 'OptimizedExecutor' });
        // Initialize connection pool
        this.connectionPool = new connection_pool_js_1.ClaudeConnectionPool({
            min: config.connectionPool?.min || 2,
            max: config.connectionPool?.max || 10,
        });
        // Initialize file manager
        this.fileManager = new async_file_manager_js_1.AsyncFileManager({
            write: config.fileOperations?.concurrency || 10,
            read: config.fileOperations?.concurrency || 20,
        });
        // Initialize execution queue
        this.executionQueue = new p_queue_1.default({
            concurrency: config.concurrency || 10,
        });
        // Initialize result cache
        this.resultCache = new ttl_map_js_1.TTLMap({
        ...
        this.executionHistory = new circular_buffer_js_1.CircularBuffer(1000);
...
exports.OptimizedExecutor = OptimizedExecutor;
