...
exports.SwarmResultAggregator = void 0;
const node_events_1 = require("node:events");
const node_perf_hooks_1 = require("node:perf_hooks");
const logger_js_1 = require("../core/logger.js");
const helpers_js_1 = require("../utils/helpers.js");
class SwarmResultAggregator extends node_events_1.EventEmitter {
    logger;
    config;
    memoryManager;
    ...
    constructor(config = {}, memoryManager) {
        super();
        this.logger = new logger_js_1.Logger('SwarmResultAggregator');
    ...
    async startAggregation(context) {
        const aggregationId = (0, helpers_js_1.generateId)('aggregation');
    ...
    async createReport(result, format) {
        const reportId = (0, helpers_js_1.generateId)('report');
        ...
        const processingTime = node_perf_hooks_1.performance.now() - startTime;
        const report = {
            id: reportId,
...
exports.SwarmResultAggregator = SwarmResultAggregator;
// Supporting classes
class AggregationSession {
    ...
    async finalize() {
        ...
        const processingStartTime = node_perf_hooks_1.performance.now();
        // Consolidate outputs
        ...
        const processingTime = node_perf_hooks_1.performance.now() - processingStartTime;
        const result = {
            id: this.id,
            swarmId: this.context.swarmId.id,
            timestamp: this.startTime,
    ...
    async generateRecommendations() {
        ...
        return [
            {
                id: (0, helpers_js_1.generateId)('recommendation'),
...
exports.default = SwarmResultAggregator;
