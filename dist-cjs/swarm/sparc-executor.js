...
exports.SparcTaskExecutor = void 0;
...
class SparcTaskExecutor {
    ...
    constructor(config = {}) {
        this.logger =
            config.logger ||
                new logger_js_1.Logger({ level: 'info', format: 'text', destination: 'console' }, { component: 'SparcTaskExecutor' });
...
exports.SparcTaskExecutor = SparcTaskExecutor;
