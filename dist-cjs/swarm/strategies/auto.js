...
class AutoStrategy extends base_js_1.BaseStrategy {
    mlHeuristics;
    decompositionCache;
    patternCache;
    performanceHistory;
    ...
    async generateDevelopmentTasks(objective, complexity) {
        const tasks = [];
        const baseId = (0, helpers_js_1.generateId)('task');
...
exports.AutoStrategy = AutoStrategy;
