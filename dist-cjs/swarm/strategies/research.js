...
class ResearchStrategy extends base_js_1.BaseStrategy {
    ...
    semanticModel; // Placeholder for semantic analysis
...
Ensure the report is well-structured and actionable.`, {
    ...
    getMetrics() {
        ...
        return {
            ...
            cacheHitRate: this.researchMetrics.cacheHits /
    ...
    async refineResearchScope(objective, intermediateResults) {
        ...
        if (intermediateResults.length > 0) {
            const avgCredibility = intermediateResults.map((r) => r.credibilityScore || 0.5).reduce((a, b) => a + b, 0) /
