...
exports.CLI_EXAMPLES = exports.USAGE_EXAMPLES = exports.TaskCoordinator = exports.createTaskWorkflowCommand = exports.createTaskCancelCommand = exports.createTaskStatusCommand = exports.createTaskListCommand = exports.createTaskCreateCommand = exports.TaskEngine = void 0;
exports.initializeTaskManagement = initializeTaskManagement;
exports.createTaskTodos = createTaskTodos;
exports.launchParallelAgents = launchParallelAgents;
exports.storeCoordinationData = storeCoordinationData;
exports.retrieveCoordinationData = retrieveCoordinationData;
var engine_js_1 = require("./engine.js");
Object.defineProperty(exports, "TaskEngine", { enumerable: true, get: function () { return engine_js_1.TaskEngine; } });
var commands_js_1 = require("./commands.js");
Object.defineProperty(exports, "createTaskCreateCommand", { enumerable: true, get: function () { return commands_js_1.createTaskCreateCommand; } });
Object.defineProperty(exports, "createTaskListCommand", { enumerable: true, get: function () { return commands_js_1.createTaskListCommand; } });
Object.defineProperty(exports, "createTaskStatusCommand", { enumerable: true, get: function () { return commands_js_1.createTaskStatusCommand; } });
Object.defineProperty(exports, "createTaskCancelCommand", { enumerable: true, get: function () { return commands_js_1.createTaskCancelCommand; } });
Object.defineProperty(exports, "createTaskWorkflowCommand", { enumerable: true, get: function () { return commands_js_1.createTaskWorkflowCommand; } });
var coordination_js_1 = require("./coordination.js");
Object.defineProperty(exports, "TaskCoordinator", { enumerable: true, get: function () { return coordination_js_1.TaskCoordinator; } });
/**
...
async function initializeTaskManagement(config = {}) {
    ...
    const { TaskEngine } = await Promise.resolve().then(() => __importStar(require('./engine.js')));
    const { TaskCoordinator } = await Promise.resolve().then(() => __importStar(require('./coordination.js')));
    const { createTaskCreateCommand, createTaskListCommand, createTaskStatusCommand, createTaskCancelCommand, createTaskWorkflowCommand, } = await Promise.resolve().then(() => __importStar(require('./commands.js')));
...
exports.default = {
    ...
    USAGE_EXAMPLES: exports.USAGE_EXAMPLES,
    CLI_EXAMPLES: exports.CLI_EXAMPLES,
};
